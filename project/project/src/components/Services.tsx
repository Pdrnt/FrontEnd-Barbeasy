...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Comunicação automática via WhatsApp com barbeiros e clientes.',
    },
    {
      icon: <Bot className="h-12 w-12 text-yellow-400" />,
      title: 'IA Assistente',
      description: 'Inteligência artificial para auxiliar barbeiros e clientes com agendamentos.',
    },
    {
